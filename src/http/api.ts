...
export const getGetSubscriberInviteCountUrl = (subscriberId: string) => {
  return `http://127.0.0.1:3333/subscribers/${subscriberId}/ranking/count`;
};
...
export const getSubscriberInviteCount = async (
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: getSubscriberInviteCountResponse['data'] = body
    ? JSON.parse(body)
    : {};
  ...
  return {
    ...
    status: res.status,
    headers: res.headers,
  } as getSubscriberInviteCountResponse;
};
...
export const getGetSubscriberInviteClicksUrl = (subscriberId: string) => {
  return `http://127.0.0.1:3333/subscribers/${subscriberId}/ranking/clicks`;
};
...
export const getSubscriberInviteClicks = async (
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: getSubscriberInviteClicksResponse['data'] = body
    ? JSON.parse(body)
    : {};
  ...
  return {
    ...
    status: res.status,
    headers: res.headers,
  } as getSubscriberInviteClicksResponse;
};
...
export const getSubscriberRankingPosition = async (
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text();
  const data: getSubscriberRankingPositionResponse['data'] = body
    ? JSON.parse(body)
    : {};
  ...
  return {
    ...
    status: res.status,
    headers: res.headers,
  } as getSubscriberRankingPositionResponse;
};
